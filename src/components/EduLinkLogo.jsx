const EdulinkLogo = ({ onClick, className, height,width }) => (
  <div onClick={onClick} className={className}>
    ...
    width={width} height={height}>
      ...
      <text x="150" y="100" fontFamily="Arial, sans-serif" fontSize="60" fill="#333" fontWeight="bold">
        Edulink
      </text>
    </svg>
  </div>
